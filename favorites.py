...
favorite_music = ''
print(f'One of ITEC 2905s favorite types of music is {favorite_music}')
...
favorite_animal = ''
print(f'One of ITEC 2905s favorite animals is {favorite_animal}')
...
favorite_programming_language = 'Binary'
print(f'One of ITEC 2905s favorite programming languages is {favorite_programming_language}')
